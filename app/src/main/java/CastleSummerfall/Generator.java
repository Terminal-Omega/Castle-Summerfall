...
public class Generator {
    ...
    public static Room generateRoom(int interactableMin, int interactableMax,
        ...
        List<Interactable> roomInventory = new ArrayList<Interactable>();
        Door door1;
        Door door2;
    ...
    public static Room generateRoom(RoomPreset preset, int interactableMin,
        ...
        List<Interactable> roomInventory = new ArrayList<>();
        ...
        List<Interactable> descriptionInteractables = new ArrayList<>();
    ...
    public static Interactable spinInteractable(InteractablePreset preset) {
        ...
        List<InteractablePreset.AbilityOption> options = new ArrayList<>();
        ...
        for (InteractablePreset.AbilityOption abilityOption : options) {
                Collections.shuffle(abilityOption.options);
                abilities.addAll(abilityOption.options.subList(0, abilityOption.number));
        }
