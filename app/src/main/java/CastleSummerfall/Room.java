 ...
 *         Stores the objects in the room, whether it's been visited, whether
 *         it's bookmarked, whether there are stairs, and the doors south and
 *         east of it. The system of storing doors allows to easily access doors
 *         from the floor class because every door that exists will be stored in
 *         a room. It also stores what the room looks like and allows the player
...
public class Room {
    ...
    // Stores some booleans about the state of the room, such as if it's been
    // visited
    ...
    /**
     * very simple, just gets the description of the room, saying which objects are
     * in it. DO NOT USE, you should use the getDescription in the Floor class.
     * 
    ...
    public String getDescription() {
        ...
        case 2:
            describe.append("\n");
            describe.append(String.format("In the room is a %s and a %s", interactables.get(0).getName(),
                    interactables.get(1).getName()));
            break;
        default:
            describe.append("\n");
    ...
    /**
     * DO NOT USE THIS METHOD. USE THE ONE IN THE FLOOR CLASS. This method only
     * exists to allow the Floor class to access its doors.
     * 
     * @param direction the direction you want the door in. Accepts only South and
     *                  East
     ...
     * @param index which occurence of the item, starting at 0 for the first
     *              occurence. Defaults to 0 if not set.
     * 
     ...
     * @param name  the name of the item
     * @param index which occurence of the item, starting at 0 for the first
     *              occurence. Defaults to 0 if left out.
     * @return an Interactable corresponding to the name
     * @throws ThingNotFoundException Throws this exception if it's not found.
     */
    ...
    /**
     * make a bookmark for the room to mark it for later. These are visible in the
     * map.
     *
     * @param bookmark
     * @param description
    ...
    /**
     * This method gets an interactable just like getItem, but it gets it from the
     * description interactables instead.
     *
     * @param name
