...
/**
 * This class is an incomplete, yet adequate, JSON parser. I built it from
 * scratch because I was under the impression we weren't allowed to use external
 * libraries and Java doesn't have built-in JSON parsing.
 */
public class Parser {

    /**
     * takes in a string that is the key of the attribute and a string to a load
     * from and returns the string that correlates with that key
     *
     * @param attribute
     * @param toLoad
     * @return String
    ...
    public static String parseString(String attribute, String toLoad) {
        ...
        // then returns the contents of the string, or an empty string if not found.
    ...
    /**
     * loads an integer or integer range based on the name of the attribute
     * associated with it. integers must be enclosed in quotes for this to work.
     *
     * @param attribute
     * @param toLoad
     * @return int[]
    ...
    public static int[] parseInt(String attribute, String toLoad) {
        // searches for a number (i.e "0") or range of numbers (i.e. "4-6") enclosed in
        // quotes and preceded by the attribute name
    ...
    public static String[] parseArray(String attribute, String toLoad) {
        // if it can't find the attribute, it assumes that the whole string is the array
        // and starts with an opening square bracket.
        String arrayString;
        ...
        do {
            ...
            // for each character, increment or decrement how many layers of brackets you
            // are in according to that character.
            ...
            if (nextChar == '[') {
                ...
                // if the character is a comma between items in the array, return a substring
                // and update the starting index to the new location
    ...
    /**
     * remove the quotes from each element of an array of strings that were
    ...
    /**
     * load an object. Not currently used for anything, but was easy to implement
     * because it was similar to parseArray
     *
     * @param attribute
     * @param toLoad
     * @return String
