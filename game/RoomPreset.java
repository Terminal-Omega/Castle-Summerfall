...
/**
 * @author @Corbanator
 * A preset for a room, complete with a set of possible descriptions and interactables to allow the player to inspect what is described in the description
 */
