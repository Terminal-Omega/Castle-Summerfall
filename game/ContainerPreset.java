...
/**
 * @author @Corbanator
 * A special form of InteractablePreset with extra fields due to it being a container, such as inventory capacity and how many items spawn inside of it.
 */
public class ContainerPreset extends InteractablePreset{
    int inventorySize;
    int valueFactor; // How valuable are the items inside? Currently unused but kept for extensibility.
    int minItems;
    int maxItems;
